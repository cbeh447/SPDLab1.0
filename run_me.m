...
%% Select Influent type  
% When you select one influent comment other influent
influent = 'avedore';  % Avedøre WWTP
% influent = 'lynetten';  % Lynetten WWTP
% influent = 'valladolid'; % Valladolid WWTP
